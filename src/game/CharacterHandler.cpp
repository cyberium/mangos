...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADBGDATA,          "SELECT instance_id, team FROM character_battleground_data WHERE guid = '%u'", m_guid.GetCounter());
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADENTRYPOINTDATA,  "SELECT join_x, join_y, join_z, join_o, join_map, taxi_start, taxi_end, mount_spell FROM character_entrypoint_data WHERE guid = '%u'", m_guid.GetCounter());
